...
def get_vis(frame):
    gps_points = gpsPoint.read_drone_csv(r'vir-atlas-master\vir-atlas-master\Data Files\Feb-26th-2021-05-57PM-Flight-Airdata.csv')
    stella_points = StellaPoint.make_stella_points(r'vir-atlas-master\vir-atlas-master\Data Files\data.csv')
